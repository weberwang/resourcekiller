...
var PATH = {
    html: Editor.url('packages://resourcekiller/panel/panel.html'),
    style: Editor.url('packages://resourcekiller/panel/less.css'),
    ignore: Editor.url('packages://resourcekiller/panel/ignore.json')
};
    ...
    return new Vue({
        ...
        methods: {
            refresh() {
                ...
                adb.queryAssets(
                    null, ['scene', 'prefab', 'animation-clip'],
                    function (err, objs) {
                        adb.queryAssets(
                            null,
                            self.type,
